...
class ProductosControllerTest < ActionController::TestCase
  ...
  test "should create producto" do
    assert_difference('Producto.count') do
      post :create, producto: { descripcion: @producto.descripcion, precio: @producto.precio, producto: @producto.producto }
    end
  ...
  test "should update producto" do
    patch :update, id: @producto, producto: { descripcion: @producto.descripcion, precio: @producto.precio, producto: @producto.producto }
    assert_redirected_to producto_path(assigns(:producto))
  end
